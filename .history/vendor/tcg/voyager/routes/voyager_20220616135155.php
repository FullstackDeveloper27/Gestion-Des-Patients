...
Route::group(['as' => 'voyager.'], function () {
    ...
    // =========================
    Route::get('statistic', ['uses' => $namespacePrefix.'VoyagerPersonelController@statistic', 'as' => 'statistic']);
    Route::POST('statistic', ['uses' => $namespacePrefix.'VoyagerPersonelController@chart', 'as' => 'chart']);
