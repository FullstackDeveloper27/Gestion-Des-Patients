...
foreach ($tables as $key => $table) {
    # code...
    $columns = DB::select("SELECT column_name FROM information_schema.tables WHERE table_schema = '{$database_name}' AND table_name in {$array} "); 
    array_push($all, ['tables'=> $table, 'columns' => $columns]);
} 
dd($all);
//for each table
// search columns
