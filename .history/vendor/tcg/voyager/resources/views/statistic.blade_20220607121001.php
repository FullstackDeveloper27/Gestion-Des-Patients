                    ...
                    <div class="col-md-3">
                        ...
                        <script>
                            function filtrer() {
                              ...
                              $.getJSON('dropdown1.json', function (data) {
                          
                                  let arr_table_type = [];
                          
                                  $.each(data, function (index, value) {
                                    arr_table_type.push(value.Type);
                                      arrData = data;
                                  });
                          
                                  // Remove duplicates. We want unique bird types.
                                  arr_table_type = Array.from(new Set (arr_table_type));
                                  ...
                                  $.each(arr_table_type, function (index, value) {
                              ...
                              $('#dropdown1').change(function () {
                                  ...
                                  $('#dropdown2')
                                      .empty()
                                      .append('<option value=""> -- Select Attribut -- </option>');
                          
                                  $.each(filterData, function (index, value) {
                                      // Now, fill the second dropdown list with bird names.
                                      $('#dropdown2').append('<option value="' + value.ID + '">' + value.Name + '</option>');
                                  });
                              });
                            });
                          </script>
