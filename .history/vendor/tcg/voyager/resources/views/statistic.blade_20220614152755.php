            ...
            <form id="contact_form" action="{{ route('voyager.chart') }}" method="POST">
                ...
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <input type="date" name="date" id="date" class="form-control" style="width: 60%;height:35px; margin-top: 27px"><input type="date" name="date" id="date" class="form-control" style="width: 60%;height:35px; margin-top: 27px">
