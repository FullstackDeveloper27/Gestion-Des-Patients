                ...
                <div class="row">
                    <div class="col-md-3" style="width: 20%">
                        ...
                        <select name="created_at" class="form-control" style=" height:35px ; width:196px"
                            ...
                            @php
                                ...
                                $array = "('branches', 'dossiers', 'visites', 'patients')";
                    ...
                    <div class="col-md-3">
                        ...
                        <select name="attribut" class="form-control" style=" height:35px ; width:196px"
                            id="dropdown2" onchange="filtrer()">
                            @php
                                $tables = DB::select("SHOW COLUMNS FROM branches");
                            @endphp
                                <option value="">Sélectionner Attribut : *</option>
                                @foreach($column as $suboption)
                        ...
                        <script>
                            $("select.dropdown1").filtrer(function(){
                                var selectedTable = $(this).attribut("option:selected").val();
                                alert("You have selected the table - " + selectedTable);
                            });
                        </script>
                    </div>
