        ...
        <body>
            ...
            <div class="col-md-12">
                ...
                <div class="row" style="width: 51%">
                    ...
                    <div class="col-md-3">
                        <input type="radio" id="Line_Chart" name="chart" value="Line_Chart" onclick="displayRadioValue()">
                    ...
                    <script>  
                        function checkButton() {    
                                    if(document.getElementById('Line_Chart').checked) {   
                                        document.getElementById("Line_Chart").value   
