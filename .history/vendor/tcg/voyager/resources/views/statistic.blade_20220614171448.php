            ...
            <form id="contact_form" action="{{ route('voyager.chart') }}" method="POST">
                ...
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <input type="date" name="date1" id="date1" class="form-control" style="width: 120%;height:35px; margin-top: 27px">
                        </div>
                        <div class="col-md-2">
                            <input type="date" name="date2" id="date2" class="form-control" style="width: 120%;height:35px; margin-top: 27px">
