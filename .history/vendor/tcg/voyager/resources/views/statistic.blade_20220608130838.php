...
$tables = DB::select("SELECT table_name FROM information_schema.tables WHERE table_schema = '{$database_name}' AND table_name in {$array} ")->map('table_name')->pluck('table_name');  
// var_dump($array);
$all = array();
