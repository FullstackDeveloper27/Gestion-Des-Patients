        ...
        <body>
            ...
            <div class="col-md-12">
                ...
                <div class="row" style="width: 51%">
                    <div class="col-md-3">
                        <input type="radio" id="Circ_Chart" name="Circ_Chart" value="Circ_Chart" onclick="displayRadioValue()" >
                        <img class="Circular-Chart" src="{{ asset('/storage/Circular-Chart.jpg') }}" >                              
                        <label for="huey">Circular Chart</label>
                    </div>
                    <div class="col-md-3" >
                        <input type="radio" id="Rect_Chart" name="Rect_Chart" value="Rect_Chart" onclick="displayRadioValue()">
                        <img class="Rectangular-Chart" src="{{ asset('/storage/Rectangular-Chart.jpg') }}">  
                        <label for="huey">Rectangular Chart</label>
                    </div>
                    <div class="col-md-3">
                        <input type="radio" id="Line_Chart" name="Line_Chart" value="Line_Chart" {{ ($page->is_active=="1")? "checked" : "" }}>
