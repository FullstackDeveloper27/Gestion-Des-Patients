        ...
        <body>                  
            <form id="contact_form" action="{{ route('voyager.chart') }}" method="POST">
                ...
                <div class="row">
                        ...
                        <div class="card" style="margin-top: 15%;">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    style="width: 50%;height:35px; margin-top: 27px">
                                </div>
                                <div class="col-md-6">
                                    <input type="date" name="date2" id="date2" class="form-control" 
                                    style="width: 50%;height:35px; margin-top: 27px; margin-left: -55%;">
                                </div>
                            </div>
                            <div class="row">
                                <label for="huey">Selectionner Chart :</label><br>
                                    <div class="col-md-4">
                                        ...
                                        <img class="Circular-Chart" src="{{ asset('/storage/Circular-Chart.jpg') }}"><br>
                                    ...
                                    <div class="col-md-4" style=" margin-left: -17%;">
                                        ...
                                        <img class="Rectangular-Chart" src="{{ asset('/storage/Rectangular-Chart.jpg') }}"><br>
                                    ...
                                    <div class="col-md-4" style=" margin-left: -13%;">
                                        ...
                                        <img class="Line-Chart" src="{{ asset('/storage/Line-Chart.png') }}"><br>
                    ...
                    <div class="col-md-6">                        
                        <div class="row" style="width: 835px;height: 645px; margin-left:2%">
                            <center> <h5>{{ $chart1->options['chart_title'] }}</h5> </center>
                            {!! $chart1->renderHtml() !!}
                        </div>
                    </div>
                </div>
