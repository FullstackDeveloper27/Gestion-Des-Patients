            ...
            <div class="col-md-12">
                <div class="row">
                    <div class="col-md-3" style="width: 20%">
                        ...
                        <select name="dropdown1" class="form-control" style=" height:35px ; width:196px" id="dropdown1"
                            onChange="showitems()">

                            <option disabled selected>All</option>
                            @foreach ($tables as $key => $table)
                                <option value="{{ $table->table_name }}">{{ $table_names[] = $table->table_name }}
                                </option>
                        ...
                        <script type="text/javascript">
                            function showitems() {
                                ...
                                columns.forEach(column => {
                                    var opt = document.createElement('option');
                                    opt.value = column.COLUMN_NAME;
                                    opt.innerHTML = column.COLUMN_NAME;
                                    select2.appendChild("<option value=");
                                });
                    ...
                    <div class="col-md-3">
                        ...
                        <select name="attribut" class="form-control" style=" height:35px ; width:196px" id="dropdown2">
                            <option disabled selected>All</option>
