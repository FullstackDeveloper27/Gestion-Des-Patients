    ...
    <div class="page-content">
        <body>
            ...
            <div class="col-md-12">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <select name="created_at" class="form-control" style=" height:35px ; width:138px"
                            id="dropdown1">
                            @php
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="attribut" class="form-control" style=" height:35px ; width:138px"
            ...
            <div class="col-md-12">
                <div class="row">
                    <div class="col-md-3">
                        <label for="huey">Selectionner Chart :</label>
                    </div>
                    <div class="col-md-3">
