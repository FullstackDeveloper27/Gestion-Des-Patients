            ...
            <div class="col-md-12">
                <div class="row">
                    <div class="col-md-3" style="width: 20%">
                        ...
                        <select name="created_at" class="form-control" style=" height:35px ; width:196px"
                            id="dropdown1" onchange="filtrer()">
                            @php
                            ...
                            @endphp
                                ...
                                @foreach($tables as $key => $table)
                                    <option>{{ $table_names[] = $table->table_name }}</option>
                    ...
                    <div class="col-md-3">
                        ...
                        <script>
                            ...
                            let filtrer = (ele) => {
                                let msg = document.getElementById('dropdown1');
                                msg.innerHTML = 'Selected Text: <b>' + ele.options[ele.selectedIndex].text + '</b> </br>' +
                                    'Value of the Selected Text: <b>' + ele.value + '</b>';
                            }
                           window.onload = function() {
                            var all_tables = document.getElementById("dropdown1");
                            var attributs = document.getElementById("dropdown2");
                            for (var x in subjectObject) {
                                all_tables.options[all_tables.options.length] = new Option(x, x);
                            }
                            all_tables.onchange = function filtrer() {
                                //empty Chapters- and Topics- dropdowns
                                attributs.length = 1;
                                //display correct values
                                for (var y in subjectObject[this.value]) {
                                attributs.options[attributs.options.length] = new Option(y, y);
                                }
                            }
                        }
                        </script>
