        ...
        <body>
            ...
            <div class="col-md-12">
                ...
                <div class="row" style="width: 51%">
                    <div class="col-md-3">
                        <input type="radio" id="Circ_Chart" name="chart" value="Circ_Chart" onclick="checkRadio(name)" checked>
                        <img class="Circular-Chart" src="{{ asset('/storage/Circular-Chart.jpg') }}">
                        <label for="huey">Circular Chart</label>
                    </div>
                    <div class="col-md-3">
                        <input type="radio" id="Rect_Chart" name="chart" value="Rect_Chart" onclick="checkRadio(name)">
                        <img class="Rectangular-Chart" src="{{ asset('/storage/Rectangular-Chart.jpg') }}">
                        <label for="huey">Rectangular Chart</label>
                    </div>
                    <div class="col-md-3">
                        <input type="radio" id="Line_Chart" name="chart" value="Line_Chart" onclick="checkRadio(name)">
