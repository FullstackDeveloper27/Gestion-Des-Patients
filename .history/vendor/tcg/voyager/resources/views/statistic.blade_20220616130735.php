                ...
                <div class="row">
                    <div class="col-md-6">                            
                        <div class="card">
                            ...
                            <select name="dropdown1" class="form-control" style=" height:35px ; width:222px" id="dropdown1"
                                onChange="showitems()">
                                @php
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <input type="date" name="date1" id="date1" class="form-control" style="width: 50%;height:35px; margin-top: 27px">
                                </div>
                                <div class="col-md-6">
                                    <input type="date" name="date2" id="date2" class="form-control" style="width: 50%;height:35px; margin-top: 27px;     margin-left: -55%;
                                    ">
                                </div>
                            </div>
                            <div class="row">
