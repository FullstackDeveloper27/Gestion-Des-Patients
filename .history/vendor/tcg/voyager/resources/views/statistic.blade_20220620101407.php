...
@section('content')   
    <div class="page-content">
        <body>             
            <center>
                <h3>**Statistic** {{ $chart1->options['chart_title'] }} </h3>
            </center>                 
                ...
                <div class="row" style="padding: 20px">
                    <div class="col-md-4">                            
                        <div class="card" style="padding: 20px;">
                            ...
                            <select name="dropdown1" class="form-control" id="dropdown1"
                                onChange="showitems()" style="margin-bottom: 10%;">
                                @php
                                    // $tables = DB::select('SHOW TABLES'); 2ème méthode
                                    $database_name = 'gest_archivage';
                                    $array = "('branches', 'dossiers', 'visites', 'patients','services')";
                                    $tables = DB::table('data_types')->get();
                                    // dd($tables);
                                    ...
                                    foreach ($tables as $key => $table) 
                                    {
                                        ...
                                        $columns = DB::select("SELECT
                                            ...
                                            WHERE TABLE_NAME = '{$table->slug}'
                                            AND TABLE_SCHEMA = '{$database_name}' ");
                                        array_push($all, ['model'=>$table->model_name, 'table' => $table->slug, 'columns' => $columns]);
                                    // dd($all);
                                    }
                                    //dd($all);
                                    //for each table
                                ...
                                @foreach ($tables as $key => $table)
                                    <option value="{{ $table->model_name }}">{{ $table_names[] = $table->slug }}
                                    </option>
                            ...
                            {{-- 
                                <script type="text/javascript">
                                    function showitems() 
                                    {
                                        ...
                                        var ligne = all.find((objet) => objet.model == option)
                            ...
                            <div class="row">
                                <label for="huey">Selectionner Chart :</label><br><br>
                                    <div class="col-md-4">
                                        <input type="radio" id="Circ_Chart" name="chart" value="pie" checked>
                                        <img class="Circular-Chart" src="{{ asset('/storage/Circular-Chart.jpg') }}"><br><br>
                                        <label for="huey">Circular Chart</label>
                                    </div>
                                    <div class="col-md-4">
                                        <input type="radio" id="Rect_Chart" name="chart" value="bar" >
                                        <img class="Rectangular-Chart" src="{{ asset('/storage/Rectangular-Chart.jpg') }}"><br><br>
                                        <label for="huey">Rectangular Chart</label>
                                    </div>
                                    <div class="col-md-4">
                                        <input type="radio" id="Line_Chart" name="chart" value="line" >
                                        <img class="Line-Chart" src="{{ asset('/storage/Line-Chart.png') }}"><br><br>
                    ...
                    <div class="col-md-8">                        
                        <div class="row card" style="{{ $chart1 == 'Circ_Chart' ? 'padding-top: 0px !important; padding: 206px !important;' : ''  }}"
                        style="padding-top: 0px !important; padding: 206px !important;"
                        @else style="padding: 20px" @endif >                            
