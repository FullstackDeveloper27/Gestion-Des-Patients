...
@section('content')
    ...
    <div class="page-content">
        ...
        <body>
            <center>
                <h3>**Statistic** Gestion-Patients.com</h3>
            </center>
            ...
            <form id="contact_form" action="{{ route('voyager.chart') }}" method="POST">
                ...
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <input type="date" name="date" id="date" class="form-control" style="width: 60%;height:35px; margin-top: 27px">
                        ...
                        <div class="col-md-3">                            <input type="date" name="date" id="date" class="form-control" style="width: 60%;height:35px; margin-top: 27px">
</div>
