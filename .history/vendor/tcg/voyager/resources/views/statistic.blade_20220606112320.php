        ...
        <body>
            ...
            <div class="col-md-12">
                ...
                <div class="row" style="width: 51%">
                    <div class="col-md-3">
                        <input type="radio" id="Circ_Chart" name="chart" value="Cir_Chart" onchange="valueChanged()">
                    ...
                    <script>
                        ...
                        chart.then((response) => {
                            if (response["chart"] == "Cir_Chart") {
                                document.querySelector('input[name=chart][value="Cir_Chart"]').click();
                            } else if (response["chart"] == "Page Bottom") {
                                document.querySelector('input[name=chart][value="Rect_Chart"]').click();
                            } else {
