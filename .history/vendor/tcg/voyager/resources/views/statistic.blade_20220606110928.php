        ...
        <body>
            ...
            <div class="col-md-12">
                ...
                <div class="row" style="width: 51%">
                    <div class="col-md-3">
                        <input type="radio" id="Circular-Chart" name="drone" value="Circular-Chart" onchange="valueChanged()">
                        <img class="Circular-Chart" src="{{ asset('/storage/Circular-Chart.jpg') }}" >                              
                        <label for="huey">Circular Chart</label>
                    </div>
                    <div class="col-md-3" >
                        <input type="radio" id="Rectangular-Chart" name="drone" value="Rectangular-Chart" onchange="valueChanged()">
                        <img class="Rectangular-Chart" src="{{ asset('/storage/Rectangular-Chart.jpg') }}">  
                        <label for="huey">Rectangular Chart</label>
                    </div>
                    <div class="col-md-3">
                        <input type="radio" id="Line-Chart" name="drone" value="Line-Chart" onchange="valueChanged()">
                    ...
                    <script>
                        function valueChanged(){
                            if(document.getElementById("Circular_Chart").checked == true)
                            {
                                document.getElementById("Rectangular-Chart" && "Line-Chart").checked = false;
                            }
                            else if
                            {
                                document.getElementById("Circular-Chart").checked = false;
                            }
                        }
                    </script>
                </div>
