        ...
        <body>
            ...
            <div class="col-md-12">
                ...
                <div class="row" style="width: 51%">
                    <div class="col-md-3">
                        <input type="radio" id="Circular_Chart" name="chart" value="Circular_Chart" onchange="valueChanged()">
                        <img class="Circular-Chart" src="{{ asset('/storage/Circular-Chart.jpg') }}" >                              
                        <label for="huey">Circular Chart</label>
                    </div>
                    <div class="col-md-3" >
                        <input type="radio" id="Rectangular_Chart" name="chart" value="Rectangular_Chart" onchange="valueChanged()">
                        <img class="Rectangular-Chart" src="{{ asset('/storage/Rectangular-Chart.jpg') }}">  
                        <label for="huey">Rectangular Chart</label>
                    </div>
                    <div class="col-md-3">
                        <input type="radio" id="Line_Chart" name="chart" value="Line_Chart" onchange="valueChanged()">
                        <img class="Line-Chart" src="{{ asset('/storage/Line-Chart.png') }}">
                        <label for="huey">Line Chart</label>
                    </div>
                    <div class="col-md-3"></div>
                    <script>
                        var chart = browser.storage.sync.get('reload_mode');
                        reloadItem.then((response) => {
                            if (response["chart"] == "Periodic") {
                                document.querySelector('input[name=chart][value="Periodic"]').click();
                            } else if (response["chart"] == "Page Bottom") {
                                document.querySelector('input[name=chart][value="Page Bottom"]').click();
                            } else {
                                document.querySelector('input[name=chart][value="Line_Chart"]').click();
                            }
                        });
                    </script>
                </div>
