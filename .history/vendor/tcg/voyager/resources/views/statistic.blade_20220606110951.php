        ...
        <body>
            ...
            <div class="col-md-12">
                ...
                <div class="row" style="width: 51%">
                    <div class="col-md-3">
                        <input type="radio" id="Circular_Chart" name="drone" value="Circular-Chart" onchange="valueChanged()">
                        <img class="Circular-Chart" src="{{ asset('/storage/Circular-Chart.jpg') }}" >                              
                        <label for="huey">Circular Chart</label>
                    </div>
                    <div class="col-md-3" >
                        <input type="radio" id="Rectangular_Chart" name="drone" value="Rectangular_Chart" onchange="valueChanged()">
                        <img class="Rectangular-Chart" src="{{ asset('/storage/Rectangular-Chart.jpg') }}">  
                        <label for="huey">Rectangular Chart</label>
                    </div>
                    <div class="col-md-3">
                        <input type="radio" id="Line_Chart" name="drone" value="Line_Chart" onchange="valueChanged()">
                    ...
                    <script>
                        function valueChanged(){
                            ...
                            {
                                document.getElementById("Rectangular_Chart" && "Line_Chart").checked = false;
                            }
                            else if
                            {
                                document.getElementById("Circular_Chart").checked = false;
                            }
                        }
                    </script>
                </div>
