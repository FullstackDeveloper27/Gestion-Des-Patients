            ...
            <form id="contact_form" action="{{ route('voyager.chart') }}" method="POST">
                ...
                <div class="col-md-12">
                    <div class="col-md-3" style="width: 22%">
                        <input type="date" name="date1" id="date1" class="form-control" style="width: 152%;height:35px; margin-top: 27px">
                    </div>
                    <div class="col-md-3">  
                        <input type="date" name="date2" id="date2" class="form-control" style="width: 12%;height:35px; margin-top: 27px">
                    </div>   
                    <div class="col-md-6">
                    </div>                    
                </div>
