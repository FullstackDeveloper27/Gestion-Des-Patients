                            ...
                            <form action="{{ route('filtre') }}" method="POST">
                                ...
                                <div class="row">
                                    <div class="col-md-3" >
                                        ...
                                        <select name="branche_id" class="form-control" style=" height:35px"
                                            ...
                                            @foreach ($branches as $branche)
                                                <option value="{{ $branche->id }}" {{ $branche->id == $branche_id ? 'selected' : '' }}>
                                                    {{ $branche->libelle  }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-md-3 ">
                                        ...
                                        <select name="service_id" class="form-control" style=" height:35px"
                                            ...
                                            @foreach ($services as $service)
                                                <option value="{{ $service->id}}" {{ $service->id == $service_id ? 'selected':'' }}>{{ $service->libelle }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select name="created_at" class="form-control" style=" height:35px"
                                            ...
                                            @php
                                                //$i = 1;
                                                $created_at = Session::get('annee');
                                            @endphp
                                                <option disabled selected>All</option>
                                                @foreach($annees as $annee)
                                                <option value="{{ $annee }}" {{ $annee == $created_at ? 'selected':'' }}>{{ $annee }}</option>
                                                @endforeach
